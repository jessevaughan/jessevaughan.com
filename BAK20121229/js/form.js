...
$(document).ready(function() {
	...
	$('#contactForm #submit').click(function() {
		...
		$('#contactForm #formProgress').html('<h2>Sending</h2>');
		...
		$.ajax({
			...
			success: function(msg) {
				...
				if(msg=='Mail sent') {
					...
					$('#contactForm #formProgress').html('<h2>Message sent!</h2>').delay(2000).fadeOut(400);
					...
					$('#contactForm #formProgress').html('');
					alert('<h2>There was an error sending your email. Please try again.</h2>');
				}
